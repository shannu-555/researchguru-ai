...
const menuItems = [
  ...
  { title: "Live Scraping", url: "/live-scraping", icon: Globe },
  { title: "Price Comparison", url: "/price-comparison", icon: DollarSign },
  { title: "Custom Dashboard", url: "/custom-dashboard", icon: LayoutDashboard },
];
